...
def load_files_from_minIO_bucket():
    ...
    client.fget_object("modelweight", "model_weights/model_weights/diff2/model_v2_768.ckpt", "model_weight_gen")
    client.fget_object("modelweight", "model_weights/model_weights/diff2/x4-upscaler-ema.ckpt", "model_weight_scaling")
    client.fget_object("modelweight", "model_weights/model_weights/diff2/512-inpainting-ema.ckpt", "model_weight_inpainting")
